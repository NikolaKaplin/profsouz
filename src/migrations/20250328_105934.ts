...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX IF NOT EXISTS "statistics_updated_at_idx" ON "statistics" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "statistics_created_at_idx" ON "statistics" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_statistics_id_idx" ON "payload_locked_documents_rels" USING btree ("statistics_id");
